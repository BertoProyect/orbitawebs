...
class Particle {
  ...
  draw(ctx: CanvasRenderingContext2D) {
    ...
    ctx.fillRect(this.pos.x, this.pos.y, 2.4, 2.4);
  }
  ...
  kill(width: number, height: number) {
    if (!this.isKilled) {
      ...
      this.targetColor = { r: 204, g: 231, b: 241 }; // celeste (se disuelve hacia el fondo)
      this.colorWeight = 0;
...
// Paleta de marca: el azul de Órbita Webs con una pequeña variación de tono
const BRAND_COLORS = [
  { r: 53, g: 90, b: 207 }, // #355ACF
  { r: 82, g: 116, b: 224 },
  { r: 30, g: 60, b: 170 },
];
...
export function ParticleTextEffect({
  ...
  useEffect(() => {
    ...
    const nextWord = (word: string) => {
      ...
      octx.font = "800 130px Inter, system-ui, sans-serif";
    ...
    const animate = () => {
      ...
      // Fondo celeste de la marca, con estela sutil (en vez del negro original)
      ctx.fillStyle = "rgba(204, 231, 241, 0.35)";
